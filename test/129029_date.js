...
const invalidDataMsg = JSON.parse(
  '{"timestamp":"2023-10-23T17:47:47.80000Z","prio":3,"src":1,"dst":255,"pgn":129029,"description":"GNSS Position Data","fields":{"SID":1,"GNSS type":"GPS","Method":"no GNSS","Integrity":"No integrity checking","Number of SVs":8,"Geoidal Separation":-0.01,"list":[{}]}}'
)
...
describe('129029 Position Data ', function () {
  it('complete sentence converts', function () {
    ...
    console.log('tree.navigation.datetime: %s', tree.navigation.datetime)
    tree.navigation.datetime.value.should.equal('2023-10-23T17:47:47.80000Z')
